// src/services/dederubot.js - Немецко-русский переводчик
...
// Используем правильный токен для de-ru бота
const token = process.env.DE_RU_TRANSLATOR;
...
console.log('[BOT] Немецко-русский переводчик запущен');
